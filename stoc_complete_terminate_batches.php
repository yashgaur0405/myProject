			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row form-group mb-2">
						<div class="col-sm-8">
							<h1>Completed and Terminated Batch Details</h1>
						</div>
						<div class="col-md-4">
								...
								<div class="col-md-12">
									...
									<div class="portlet-body" style="overflow-x: auto;">
									 ...
									 <div class="col-lg-12" style="padding-bottom:2%;padding-top:1%;">
									  <a href="download-complete-terminate-associate-detail.php?stoc" class="btn btn-primary"><i class="fa fa-download"></i> &nbsp; &nbsp; Download</a><br clear="all"><br>
									  </div>
								</div>
							</div>
						</div>
