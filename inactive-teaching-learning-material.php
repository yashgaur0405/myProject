...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <a href="download-inactive-teaching-learning-material.php?sdate=<?php echo base64_encode($cdate1); ?>&edate=<?php echo base64_encode($cdate2); ?>" class="btn btn-primary"><i class="fa fa-download"></i> &nbsp; &nbsp; Download</a><br clear="all"><br>
  </div>
          </div>
