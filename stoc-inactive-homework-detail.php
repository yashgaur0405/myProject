...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            <h1>Inactive Home-Work Detail </h1>
          </div>
        </div>
      </div>
    </section>
  ...
  <a href="download-inactive-homework-detail.php?stoc&sdate=<?php echo base64_encode($cdate1); ?>&edate=<?php echo base64_encode($cdate2); ?>" class="btn btn-primary"><i class="fa fa-download"></i> &nbsp; &nbsp; Download</a><br clear="all"><br>
  </div>
          </div>
