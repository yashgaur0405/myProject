...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            <h1>Inactive Teaching Learning Material </h1>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="tab-content" style="margin-top: -5px;padding: 0.5rem 1rem;">
                  <div id="tab_1_1" class="tab-pane show active">
                   ...
                   <tr>
                      ...
                      <td><?php echo $getList['update_date']; ?></td>
                    </tr>
                  <?php } }
                   else 
                    { ?>
  ...
  <a href="download-inactive-teaching-learning-material.php?stoc&sdate=<?php echo base64_encode($cdate1); ?>&edate=<?php echo base64_encode($cdate2); ?>" class="btn btn-primary"><i class="fa fa-download"></i> &nbsp; &nbsp; Download</a><br clear="all"><br>
  </div>
          </div>
