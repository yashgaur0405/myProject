...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="tab-content" style="margin-top: -5px;padding: 0.5rem 1rem;">
                  <div id="tab_1_1" class="tab-pane show active">
					...
					<tr>
						...
						<td><?php $get_inst = mysqli_fetch_assoc(mysqli_query($conn, "SELECT institution_name FROM tbl_associate_detail WHERE associate_id = '".$getList['institute']."' "));{ echo $get_inst['institution_name'];} ?></td>
  ...
  <a href="download-inactive-previous-summary.php?sdate=<?php echo base64_encode($cdate1); ?>&edate=<?php echo base64_encode($cdate2); ?>" class="btn btn-primary"><i class="fa fa-download"></i> &nbsp; &nbsp; Download</a><br clear="all"><br>
  </div>
          </div>
